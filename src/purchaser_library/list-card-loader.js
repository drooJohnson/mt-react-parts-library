...
const LoaderDots = () => (
  <React.Fragment><LoaderDot delay='0ms' /><LoaderDot delay='500ms' /><LoaderDot delay='1000ms' /></React.Fragment>
)
...
class CardLoader extends React.Component{
  ...
  render(){
    return(
      <LoaderWrapper><LoaderText>Calculating Network Pricing <LoaderDots/></LoaderText></LoaderWrapper>
    )
  }
}
